...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(savedScore, questionsLenght) =>
      "${Intl.plural(savedScore, zero: 'Последний результат - ${savedScore} баллов из ${questionsLenght}', one: 'Последний результат - ${savedScore} балл из ${questionsLenght}', two: 'Последний результат - ${savedScore} балла из ${questionsLenght}', few: 'Последний результат - ${savedScore} балла из ${questionsLenght}', many: 'Последний результат - ${savedScore} баллов из ${questionsLenght}', other: 'Последний результат - ${savedScore} баллов из ${questionsLenght}')} ";

  static String m2(score, questions) =>
      "Правильных ответов - ${score} из ${questions}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allUserResult":
            MessageLookupByLibrary.simpleMessage("Все результаты:"),
        ...
        "changeUser":
            MessageLookupByLibrary.simpleMessage("Сменить пользователя"),
        "currentUser":
        ...
        "lastResult": m1,
        "lastResults":
            MessageLookupByLibrary.simpleMessage("Последние результаты"),
        "leaderBoard": MessageLookupByLibrary.simpleMessage("Лидеры"),
        "nameIsTaken":
            MessageLookupByLibrary.simpleMessage("Данное имя используется"),
        ...
        "questionsFilms":
            MessageLookupByLibrary.simpleMessage("Кинофильмы СССР"),
        ...
        "toMainPage":
            MessageLookupByLibrary.simpleMessage("На главную страницу"),
        "userLastResult":
            MessageLookupByLibrary.simpleMessage("Последний результат:"),
        "userList":
            MessageLookupByLibrary.simpleMessage("Список пользователей"),
        "userListEmpty":
            MessageLookupByLibrary.simpleMessage("Список пользователей пуст"),
